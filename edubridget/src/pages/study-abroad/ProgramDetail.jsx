            ...
            <div className="bg-white rounded-xl border border-slate-200 p-8 text-center relative overflow-hidden">
              ...
              <div className="flex items-center justify-center gap-2 mb-4">
                {program.tags.map((tag) => (
                  <span
                    key={tag}
                    className="text-xs font-bold text-primary px-2 py-1 bg-primary/5 rounded-full">
                    {tag}
                  </span>
                ))}
              </div>
                ...
                <div className="space-y-4 mb-8">
                  <div className="flex justify-between items-center text-sm">
                    ...
                    <div className="flex items-center border border-slate-300 rounded">
                      ...
                      <span className="px-3 py-1 text-slate-900 font-medium min-w-[2rem] text-center">
                        {quantity}
                      </span>
                      <button
