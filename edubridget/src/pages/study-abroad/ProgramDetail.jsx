...
import { ChevronRight, Share2, Printer, ArrowLeft } from "lucide-react";
...
export default function ProgramDetail({
  ...
  */
  const handleApply = async (type = "default", payload = null) => {
    ...
    // 1. Check Authentication FIRST (Unless we are just previewing as an admin)
  ...
  return (
    <div className="min-h-screen bg-slate-50 py-8 animate-in fade-in duration-500">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Conditional Header: Dashboard Preview vs Public Breadcrumbs */}
        {previewMode ? (
          <div className="flex items-center gap-4 mb-8 print:hidden">
            ...
            <div>
              ...
              <p className="text-sm text-slate-500">
                Previewing {program.name} related information and application.
              </p>
            </div>
          </div>
        ) : (
          <div className="flex items-center text-sm text-slate-500 mb-8 print:hidden">
            <span
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8 print:col-span-3">
            {/* Header Info */}
            <div className="bg-white rounded-xl border border-slate-200 p-8 text-center relative overflow-hidden shadow-sm print:border-none print:shadow-none print:p-0">
