      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-xl border border-slate-200 p-6">
          <div className="flex items-center justify-between mb-6">
            ...
            <Link to="/admin/applications" className="text-sm text-primary font-semibold hover:underline flex items-center gap-1">
              View All <span>→</span>
            </Link>
          </div>
          ...
          <div className="flex flex-col items-center justify-center py-12 text-center">
            ...
            <p className="text-sm text-slate-500">Applications will appear here once submitted</p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl border border-slate-200 p-6">
          <div className="flex items-center justify-between mb-6">
            <h3 className="font-bold text-slate-800 text-base">Active Visa Cases</h3>
            <Link to="/admin/visa" className="text-sm text-primary font-semibold hover:underline flex items-center gap-1">
              View All <span>→</span>
            </Link>
          </div>
          ...
          <div className="flex flex-col items-center justify-center py-12 text-center">
            ...
            <p className="font-semibold text-slate-700 mb-1">No visa cases yet</p>
            <p className="text-sm text-slate-500">Visa cases will appear here once created</p>
          </div>
        </div>
      </div>
    </div>
