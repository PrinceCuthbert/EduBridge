...
import { updatePassword, getUserById, uploadUserAvatar } from "../../services/userService";
...
export default function AdminSettings() {
    ...
    const loadFreshData = async () => {
      ...
      try {
        ...
        const freshData = {
          ...
          dateOfBirth: freshUser.identity?.dob || "",
  ...
  const handleSaveProfile = async () => {
    setIsSaving(true);
    try {
      // 1. ONE CALL ONLY: We just pass the flat profileData to the Context.
      // The Context will handle both updating the DB AND updating the Session.
            ...
            <div className="flex items-center gap-4 mb-8">
              <div className="relative group shrink-0">
                <img
                  src={
                    user?.avatar ||
                    `https://ui-avatars.com/api/?name=${profileData.firstName}+${profileData.lastName}&background=0F172A&color=fff`
                  }
                  alt="Profile"
          ...
          <form onSubmit={handlePasswordChange} className="space-y-6">
            ...
            <div className="flex gap-3 pt-4">
              ...
              <button
                type="submit"
                disabled={isSaving}
                className="flex-1 px-4 py-3 bg-[#0F172A] text-white rounded-xl hover:bg-[#1E293B] transition-colors font-medium disabled:opacity-50 flex justify-center items-center gap-2">
