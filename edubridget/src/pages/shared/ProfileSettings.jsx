...
export default function ProfileSettings() {
  ...
  const [profileData, setProfileData] = useState({
    ...
    studentId: user?.role === 'admin' ? 'ADM-001' : (user?.studentId || 'EB-SM-7890'),
    phone: user?.phone || '+1 (555) 123-4567',
    dateOfBirth: user?.dateOfBirth || '1998-07-21',
    ...
    <div className="min-h-screen bg-slate-50/30 -m-8 p-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-3xl p-8 shadow-sm border border-slate-200/50">
            ...
            <div className="flex items-center gap-4 mb-8">
              <img 
                src={user?.avatar || `https://ui-avatars.com/api/?name=${profileData.name.replace(' ', '+')}&background=0F172A&color=fff`} 
              ...
              <div className="flex-1">
                {isEditing ? (
                  ...
                  <h2 className="text-xl font-semibold text-slate-900 flex items-center gap-3">
                    {profileData.name}
                    <span className={`text-[10px] uppercase font-bold px-2 py-0.5 rounded-full border ${getRoleBadge()}`}>
                        {user?.role || 'Student'}
                    </span>
                  </h2>
                )}
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-slate-900">{user?.email || 'user@example.com'}</p>
          ...
          <div className="bg-white rounded-3xl p-8 shadow-sm border border-slate-200/50">
            ...
            <div className="space-y-5">
              ...
              {/* Two-Factor Authentication - HIDDEN FOR STUDENTS */}
              {!isStudent && (
        ...
        <div className="space-y-6">
          ...
          {/* Address Information Card - REUSABLE */}
          <div className="bg-white rounded-3xl p-8 shadow-sm border border-slate-200/50">
      ...
      {/* Password Change Modal - SHARED MDOAL */}
      {showPasswordModal && (
        <Modal
