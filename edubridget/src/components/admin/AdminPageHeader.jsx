      ...
      <div className="flex items-center gap-4">
        ...
        {primaryAction && (
          <button
            ...
            className="px-8 py-3.5 bg-[#0F172A] text-white rounded-[1.25rem] text-sm font-medium shadow-[0_12px_24px_-8px_rgba(15,23,42,0.3)] hover:bg-[#1E293B] hover:translate-y-[-1px] transition-all flex items-center gap-3 active:scale-95 group"
          >
            {primaryAction.icon && (
              <primaryAction.icon 
                size={18} 
